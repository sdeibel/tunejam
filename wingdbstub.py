...
WINGHOME = "/home/maint/wingpro7/remote-7.2.7.0"
...
kLogFile = '/home/maint/log/debug.log'
...
kSecurityToken = "none:UuKrToTw17r60e3L"
...
kPWFilePath = ['~/.wingpro7/remote-7.2.7.0', os.path.dirname(__file__), '$<winguserprofile>']
